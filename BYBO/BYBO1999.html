...
<html lang="en">
  ...
  <body>
    <a href="#"><img src="../BYBO/BYBO photos/Product1999.jpg" style="height:600px; width: 100%;"></a>
    ...
    <div class="card" style="width: 18rem;float: left;margin-left: 10px;padding-right: 5px;">
      <img src="../BYBO/BYBO photos/series.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Pro Series Sonic Smart Electric Toothbrush (Rechargeable)</h5>
    ...
    <div class="card" style="width: 100%;">
      ...
      <div class="card-body" style="text-align: center;">
       <h5><b> Add 5 product(s) to get the bundle at ₹1999.00</b></h5>
      </div>
    </div>
