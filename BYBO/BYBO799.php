...
<html lang="en">
  ...
  <body>
    <a href="#"><img src="../BYBO/BYBO photos/Main2.jpg" style="height:600px; width: 100%;"></a>
    ...
    <br>
    <h2 style="text-align: center;">Add A Electric Toothbrush</h2>
    <br>
    <div class="card" style="width: 18rem;float: left;margin-left: 10px;padding-right: 5px;">
      <img src="../BYBO/BYBO photos/neoseries.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Neo Series Sonic Electric Toothbrush(Coral Red)</h5>
      ...
      <img src="../BYBO/BYBO photos/neoseries.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Neo Series Sonic Electric Toothbrush(Ocean Blue)</h5>
        <p class="card-text">₹799.00</p>
        <a href="#" class="btn btn-primary" style="margin-left: 65px;">Add To Box</a>
      </div></div>
      <div class="card" style="width: 18rem;float: left; margin-left: 10px;">
      <img src="../BYBO/BYBO photos/sonic.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Ultra Series Sonic Electric Toothbrush(Jade Green)</h5>
      ...
      <img src="../BYBO/BYBO photos/sonic.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Ultra Series Sonic Electric Toothbrush(Frosty White)</h5>
        <p class="card-text">₹1099.00</p>
        <a href="#" class="btn btn-primary" style="margin-left: 65px;">Add To Box</a>
      </div>
    </div>
