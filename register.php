...
:root {
    --hs-swiper-navigation-size: 15px;
}
:root {
...
:root {
    ...
    --btn-1-inset: ;
    --btn-2-font-family: Playfair Display;
    ...
    --product-swatch-border-radius: 50px;
    ...
    --product-marquee-background-color: linear-gradient(180deg, rgba(255, 228, 49, 1), rgba(249, 32, 32, 1) 100%);
    --product-marquee-text-color: #a1decd;
    --product-marquee-text-size: 14px;
    --product-marquee-text-mobile-size: 14px;
    --product-marquee-text-weight: 700;
...
item .form-actions .button, .register-page .login-item .form-actions .button {
    min-width: 256px;
}
...
<link href="//drdento.com/cdn/shop/t/23/assets/component-breadcrumb.css?v=27908482502108923081734948507" rel="stylesheet" type="text/css" media="all">
    ...
    <div class="halo-page-content">
        <div class="login-item">
            <div class="halo-page-wrapper">
                ...
                </div><form method="post" action="/account" id="create_customer" accept-charset="UTF-8" data-login-with-shop-sign-up="true" class="create-customer-form" data-gtm-form-interact-id="1"><input type="hidden" name="form_type" value="create_customer"><input type="hidden" name="utf8" value="✓">
                    <div class="form-field">
                        <label class="form-label" for="RegisterForm-FirstName">
                            First name
                        </label>
                        <input class="form-input form-input-placeholder" type="text" name="customer[first_name]" id="RegisterForm-FirstName" autocomplete="given-name" placeholder="" spellcheck="false" data-ms-editor="true">
                    </div>
                    <div class="form-field">
                        <label class="form-label" for="RegisterForm-LastName">
                            Last name
                        </label>      
                        <input class="form-input form-input-placeholder" type="text" name="customer[last_name]" id="RegisterForm-LastName" autocomplete="family-name" placeholder="" spellcheck="false" data-ms-editor="true">
                    </div>
                    <div class="form-field">
                        ...
                        <input class="form-input form-input-placeholder" type="email" name="customer[email]" id="RegisterForm-email" spellcheck="false" autocapitalize="off" autocomplete="email" aria-required="true" placeholder="" required="">
                    </div>
                    <div class="form-field">
                        ...
                        <input class="form-input form-input-placeholder" type="password" name="customer[password]" id="RegisterForm-password" aria-required="true" placeholder="" required="" data-gtm-form-interact-field-id="1">
                    </div>
