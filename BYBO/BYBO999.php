...
<html lang="en">
  ...
  <body>
    <a href="#"><img src="../BYBO/BYBO photos/Build.jpg" style="height:600px; width: 100%;"></a>
    ...
    <div class="card" style="width: 18rem;float: left;margin-left: 10px;padding-right: 5px;">
      ...
      <div class="container">
        ...
        <div class="bundle-message">
          Add <span id="product-count">5</span> product(s) to get the bundle at ₹<span id="bundle-price">999.00</span>
        </div>
